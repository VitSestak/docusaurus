...
- [Created application and application components](https://vitsestak.github.io/code_now/docs/admMan/creNewApp/)
...
5. Define deployment configuration
    - Select the target environment and application package version. 
      ...
      - Explicit configuration for each environment should not be required if you use dns endpoint names, ie http://component-name
      - If required, configuration for local development is possible using profiles and application-{profile}.yml configuration file.
