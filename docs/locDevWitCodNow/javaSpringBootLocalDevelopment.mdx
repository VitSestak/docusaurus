...
slug: java-spring-boot-local-development
---
...
- Create a new CodeNOW component in your application.
    ...
    - See the *[How to Create a New Application Component](https://vitsestak.github.io/code_now/docs/admMan/creNewCom/)* tutorial.
...
- Start Run/Debug in your IDE.
    ...
    - Check swagger-ui by clicking on [http://localhost:8080/swagger/index.html](http://localhost:8080/swagger/index.html)
      ...
      - Any changes made in the code are automatically propagated to swagger-ui (courtesy of [SpringFox](https://springfox.github.io/springfox/)).
