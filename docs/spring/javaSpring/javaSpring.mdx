...
<img alt="ClientDataServiceImage" src={useBaseUrl('img/spring/springBoot/ClientDataService.png')}/>
...
<img alt="ClientDataServiceImageSwagger" src={useBaseUrl('img/spring/springBoot/clientDataService_swagger.png')}/>
