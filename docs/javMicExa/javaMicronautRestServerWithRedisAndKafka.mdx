...
slug: java-micronaut-rest-server-with-redis-and-kafka
---
...
- Try to build and run application in your IDE. After startup, you should be able to access your new controller’s swagger: **[http://localhost:8080/swagger/index.html](http://localhost:8080/swagger/index.html)**
  - For correct setup, check Readme.md in project root or see tutorial [Java Micronaut Local Development](https://vitsestak.github.io/code_now/docs/locDevWitCodNow/locDev/), section *Prepare local development IDE*  
...
- check [Get New Redis](https://vitsestak.github.io/code_now/docs/manComAdm/getNewRed) and [Get New Apache Kafka](https://vitsestak.github.io/code_now/docs/manComAdm/getNewApaKaf) for setup in the CodeNOW environment
