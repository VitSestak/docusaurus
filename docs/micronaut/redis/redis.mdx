...
<img alt="clientAuthorizationService" src={useBaseUrl('img/micronaut/redis/ClientAuthorizationService.png')}/>
...
<img alt="ClientAuthorizationServiceSwagger" src={useBaseUrl('img/micronaut/redis/clientAuthorizationService_swagger.png')}/>
