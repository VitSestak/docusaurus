...
<img alt="clientDataDB" src={useBaseUrl('img/micronaut/postgre/ClientDataDB.png')}/>
...
<img alt="clientDataDBSwagger" src={useBaseUrl('img/micronaut/postgre/clientDataDB_swagger.png')}/>
