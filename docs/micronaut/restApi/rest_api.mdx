...
<img alt="clientInfoService" src={useBaseUrl('img/micronaut/restApi/ClientInfoService.png')} />
...
<img alt="clientInfoServiceSwagger" src={useBaseUrl('img/micronaut/restApi/clientInformationService_swagger.png')} />
